  ...
  >
    ...
    <template #logo>
      <nuxt-link data-cy="app-header-url_logo" :to="localePath('/')" class="sf-header__logo">
        <img src="https://media-exp1.licdn.com/dms/image/C4E0BAQFv8X2vXjB-Zw/company-logo_200_200/0/1599732981061?e=2159024400&v=beta&t=Uc3B4svENyJvAab3cOzC5KXSMjqOX67POYOdbsuqmys" alt="Vue Storefront Next" width="40" height="40" class="rounded"/>
      </nuxt-link>
    </template>
    ...
    <template>
      <nuxt-link to="/women">Womens Wear </nuxt-link>
    </template>
